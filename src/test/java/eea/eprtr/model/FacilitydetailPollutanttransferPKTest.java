 ...
 */
public class FacilitydetailPollutanttransferPKTest {
    
    
     FacilitydetailPollutanttransferPK x;
    FacilitydetailPollutanttransferPK y;
    FacilitydetailPollutanttransferPK z;
    FacilitydetailPollutanttransferPK notx;
    
    
    @Before
    public void initialize() {
        x = new FacilitydetailPollutanttransferPK(42, 9000);

        y = new FacilitydetailPollutanttransferPK(42, 9000);;

        z = new FacilitydetailPollutanttransferPK(42, 9000);;

        notx = new FacilitydetailPollutanttransferPK(2, 2000);
