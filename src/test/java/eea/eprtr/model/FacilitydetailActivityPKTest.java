 ...
 */
public class FacilitydetailActivityPKTest {

    FacilitydetailActivityPK x;
    FacilitydetailActivityPK y;
    FacilitydetailActivityPK z;
    FacilitydetailActivityPK notx;

    @Before
    public void initialize() {
        x = new FacilitydetailActivityPK("EPER_1.1", 9000);

        y = new FacilitydetailActivityPK("EPER_1.1", 9000);;

        z = new FacilitydetailActivityPK("EPER_1.1", 9000);;

        notx = new FacilitydetailActivityPK("EPER_2.2", 2000);
