 ...
 */
public class FacilitydetailPollutantreleasePKTest {
    FacilitydetailPollutantreleasePK x;
    FacilitydetailPollutantreleasePK y;
    FacilitydetailPollutantreleasePK z;
    FacilitydetailPollutantreleasePK notx;

    @Before
    public void initialize() {
        x = new FacilitydetailPollutantreleasePK(42, 9000);

        y = new FacilitydetailPollutantreleasePK(42, 9000);;

        z = new FacilitydetailPollutantreleasePK(42, 9000);;

        notx = new FacilitydetailPollutantreleasePK(2, 2000);
