 ...
 */
public class FacilitydetailWastetransferPKTest {

    FacilitydetailWastetransferPK x;
    FacilitydetailWastetransferPK y;
    FacilitydetailWastetransferPK z;
    FacilitydetailWastetransferPK notx;

    @Before
    public void initialize() {
        x = new FacilitydetailWastetransferPK(42, 9000);

        y = new FacilitydetailWastetransferPK(42, 9000);;

        z = new FacilitydetailWastetransferPK(42, 9000);;

        notx = new FacilitydetailWastetransferPK(2, 2000);
