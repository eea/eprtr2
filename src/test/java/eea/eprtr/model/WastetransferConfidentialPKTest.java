 ...
 */
public class WastetransferConfidentialPKTest {

    WastetransferConfidentialPK x;
    WastetransferConfidentialPK y;
    WastetransferConfidentialPK z;
    WastetransferConfidentialPK notx;

    @Before
    public void initialize() {
        x = new WastetransferConfidentialPK(42, 2013);

        y = new WastetransferConfidentialPK(42, 2013);;

        z = new WastetransferConfidentialPK(42, 2013);;

        notx = new WastetransferConfidentialPK(2, 2000);
