...
angular.module('myApp.diffemissionswater', ['ngRoute'])
...
.controller('DiffEmissionsWaterCtrl', ['$scope','$filter', 'translationService', function($scope, $filter, translationService) {
