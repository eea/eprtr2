...
angular.module('myApp.diffemissionsair', ['ngRoute','ngSanitize'])
...
.controller('DiffEmissionsAirCtrl', ['$scope','$filter', 'emissionsService', function($scope, $filter, emissionsService) {
