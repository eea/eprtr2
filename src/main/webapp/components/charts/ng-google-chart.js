...
angular.module('myApp.eprtrgooglechart', [])
                    ...
                    if (!draw.triggered && ($scope.chart != undefined)) {
                        ...
                        $timeout(function () {
                            ...
                            if (typeof ($scope.chartWrapper) == 'undefined') {
                                ...
                                if($scope.chart.type == 'google.charts.Bar'){
                                    $scope.chartWrapper.setOptions(google.charts.Bar.convertOptions($scope.chart.options));
                                }
                                else{
