...
import eea.eprtrcms.dao.EprtrSurveyService;
import eea.eprtrcms.model.EprtrSurvey;
import eea.eprtrcms.model.EprtrSurveyItem;
...
public class EprtrSurveyController {
    ...
    public String add(EprtrSurvey eprtrSurvey, BindingResult bindingResult, ModelMap model) {
    	...
    	return "redirect:/cms/eprtrsurvey";
    }
