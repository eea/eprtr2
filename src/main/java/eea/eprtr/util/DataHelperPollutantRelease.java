...
/*      case "AREAOVERVIEW":
    ...
    public List<ActivityPollutantQuantity> getAreaOverview(List<Pollutantrelease> elements,
            List<LovPollutant> pollist, Integer pollutantgroupid) throws CloneNotSupportedException {
