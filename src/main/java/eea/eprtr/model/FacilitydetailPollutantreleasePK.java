 ...
 */
public class FacilitydetailPollutantreleasePK implements Serializable {

    protected Integer facilityReportID;
    protected Integer LOV_PollutantID;

    public FacilitydetailPollutantreleasePK() {
    }

    public FacilitydetailPollutantreleasePK(Integer facilityReportID, Integer LOV_PollutantID) {
    ...
    public boolean equals(Object obj) {
        ...
        final FacilitydetailPollutantreleasePK other = (FacilitydetailPollutantreleasePK) obj;
