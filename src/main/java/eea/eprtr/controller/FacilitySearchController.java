...
public class FacilitySearchController {
    ...
    public FacilitySearchMainActivity[] facilitySearch(
		...
		FacilitySearchFilter filter = new FacilitySearchFilter(countryAreaGroupRepository, reportingYear, countryID, areaGroupID, regionID, rbdID, facilityName, cityName, activityFilter, pollutantFilter, wasteFilter);
